/**
 * Proxy para download de documentos do contrato autenticados
...
export async function onRequest(context) {
  ...
  const backendUrl = `https://api.gemoc-analytics.workers.dev/api/documentos-contrato/download?path=${encodeURIComponent(path)}`;
